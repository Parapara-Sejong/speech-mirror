---
name: design
description: Design and implement architecture, APIs, database, or UI/UX while following existing project patterns. Use for /design-style system design work.
---
