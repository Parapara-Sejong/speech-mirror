---
name: build
description: Build, compile, package, and diagnose build failures for the current project. Use for /build-style requests, release build checks, and build optimization.
---
