---
name: plan
description: Create an implementation strategy before editing code. Use for /plan-style requests, multi-step changes, architecture-affecting work, and pre-implementation planning.
---
