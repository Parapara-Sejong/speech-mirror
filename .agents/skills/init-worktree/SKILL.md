---
name: init-worktree
description: Create and initialize a git worktree and copy only necessary local ignored files. Use for /init-worktree-style isolated branch setup.
---

# init-worktree

Git worktree를 자동으로 생성하는 스킬입니다.
