---
name: analyze
description: Analyze code and project context without editing files. Use for /analyze-style requests, implementation planning, impact analysis, and codebase investigation before changes.
---
