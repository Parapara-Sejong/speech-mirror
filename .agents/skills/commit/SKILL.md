---
name: commit
description: Create concise Korean git commits from current changes without pushing and without Co-Authored-By trailers. Use for /commit-style smart commit requests.
---
