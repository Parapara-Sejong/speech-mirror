---
name: figma
description: Convert Figma design values into responsive project code. Use for /figma-style design-to-code tasks with Tailwind, React, React Native, Flutter, or existing styling systems.
---
