---
name: implement
description: Implement code from an existing analysis or clear request while following project style. Use for /implement-style feature, bugfix, or task execution.
---
