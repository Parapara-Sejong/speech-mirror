---
name: report
description: Generate an implementation report from git status, changed files, or issue context and save it under .report. Use for /report-style implementation summaries.
---
