---
name: document
description: Create or update technical documentation, comments, README content, API docs, and architecture docs. Use for /document-style documentation tasks.
---
