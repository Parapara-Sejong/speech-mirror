---
name: testcase
description: Generate QA test checklists from GitHub issue context and project code. Use for /testcase-style manual test plan requests.
---
...
- **파일 위치**: 프로젝트 루트 디렉토리 (`.agents/`, `src/`와 같은 레벨)

- **이유**:
    - 대화창 내부에서 마크다운 출력만 하면 복사하기 어려움
